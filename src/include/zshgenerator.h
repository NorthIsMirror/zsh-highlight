...
#ifndef ZSHGENERATOR_H
#define ZSHGENERATOR_H
...
/**
   \brief This class generates Zsh region_highlight array entries

   It contains information about the resulting document structure (document
   header and footer), the colour system, white space handling and text
   formatting attributes.

* @author Andre Simon, Sebastian Gniazdowski
*/

class ZshGenerator : public highlight::CodeGenerator
{
public:
    ZshGenerator();
    ~ZshGenerator();
...
private:
    ...
    virtual void maskString ( ostream& ss, const string &s );
